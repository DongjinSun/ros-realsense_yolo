...
(cl:defmethod cl:initialize-instance :after ((m <Target>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Target)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bin_msgs-msg:<Target> is deprecated: use bin_msgs-msg:Target instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bin_msgs-msg:x-val is deprecated.  Use bin_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bin_msgs-msg:y-val is deprecated.  Use bin_msgs-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bin_msgs-msg:z-val is deprecated.  Use bin_msgs-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <Target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bin_msgs-msg:type-val is deprecated.  Use bin_msgs-msg:type instead.")
  (type m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Target>)))
  ...
  "5b9fa2ab2744d7ffa49bcedc9d894beb")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Target)))
  "Returns md5sum for a message object of type 'Target"
  "5b9fa2ab2744d7ffa49bcedc9d894beb")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Target>)))
  ...
  (cl:format cl:nil "float32 x~%float32 y~%float32 z~%string type~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Target)))
  "Returns full string definition for message of type 'Target"
  (cl:format cl:nil "float32 x~%float32 y~%float32 z~%string type~%~%~%"))
